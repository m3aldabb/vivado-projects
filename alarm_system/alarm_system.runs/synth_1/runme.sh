...
HD_PWD='C:/Users/14168/vivado-workspace/projects/alarm_system/alarm_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw_top.tcl
