...
HD_PWD='C:/Users/14168/vivado-workspace/projects/alarm_system/alarm_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hw_top.tcl -notrace
